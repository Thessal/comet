...
// use parser::behavior::{BehaviorDecl, Ident, TYPE_DECL_LENGTH, TypeDecl};
...
//                 let action = Action::from(a.clone());
...
//     behavior: &parser::behavior::BehaviorDecl,
//     available_funcs: &[runtime::ast::OperatorSpec],
...
//             .sequence
//             .last()
//             .map(|action_str| action_space.action_to_id(&Action::from(action_str.clone())))
//             .unwrap_or(0);
