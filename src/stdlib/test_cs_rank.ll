; src/stdlib/test_cs_rank.ll

%CsRankState = type opaque

declare %CsRankState* @comet_cs_rank_init(i64, i64)
declare void @comet_cs_rank_step(%CsRankState*, double*, double*, i64)
declare void @comet_cs_rank_free(%CsRankState*)
...
define i32 @main() {
entry:
    ; Initialize cs_rank with period = 1, len = 4
    %state = call %CsRankState* @comet_cs_rank_init(i64 1, i64 4)
    ...
    ; Step 1: [10.0, 30.0, 20.0, 10.0] -> Ranks should be 1.5, 4.0, 3.0, 1.5
    ...
    call void @comet_cs_rank_step(%CsRankState* %state, double* %a_ptr, double* %out_ptr, i64 4)
    ...
    call i32 (i8*, ...) @printf(i8* %fmt_ptr, i32 1, double 10.0, double 30.0, double 20.0, double 10.0, double %o0_1, double %o1_1, double %o2_1, double %o3_1)
    
    ; Step 2: [NaN, 30.0, NaN, 10.0] -> Ranks: NaN, 2.0, NaN, 1.0
    ...
    ; Cleanup
    call void @comet_cs_rank_free(%CsRankState* %state)
